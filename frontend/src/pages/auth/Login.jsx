      ...
      <div className="grid w-full max-w-5xl overflow-hidden rounded-xl2 shadow-glass lg:grid-cols-2">
        ...
        >
          <div>
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-md bg-violet-600 font-display text-xl font-bold">
                E
              </div>
          ...
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm text-slate-400">
              Attendance, homework, fees, and results — synced in real time for
          ...
          <div className="flex gap-6 border-t border-white/10 pt-5 text-xs text-slate-400">
            <div>
              <p className="font-display text-lg font-semibold text-white">5</p>
              role dashboards
            </div>
            <div>
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
            <div>
              <label className="mb-1.5 block text-xs font-medium text-ink-600/70 dark:text-mist-200/50">
                Email
              </label>
